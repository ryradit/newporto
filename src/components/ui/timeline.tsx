...
export function TimelineItem({ title, company, location, period, responsibilities, companyLogo }: TimelineItemProps) {
      ...
      <div className={`bg-card rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-primary/10 ${isExpanded ? 'scale-[1.02]' : ''}`}>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-grow">
            <h3 className="font-headline text-xl font-medium text-primary mb-1">{title}</h3>
            <div className="text-lg font-medium text-foreground/90 mb-1">{company}</div>
